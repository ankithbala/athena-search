...
DEFAULT_QUESTION_AT_STARTUP = os.getenv("DEFAULT_QUESTION_AT_STARTUP", "How important is Math in this course?")
...
def main():
    ...
    # Title
    st.write("# Chatbot for course logistics")
    st.markdown(
        """
Knowledge base for students related to course logistics



Serves as a closed-domain intelligence search system to search course logistics document.
    ...
    if st.session_state.results:
        ...
        for count, result in enumerate(st.session_state.results):
            ...
            if eval_mode and result["answer"]:
                ...
                if(result.get("_raw")):
                    ids = result["_raw"]["document_ids"]
                    print(ids)
                    
                    if ids!=None:
                        id = result["_raw"]["document_ids"][0]
